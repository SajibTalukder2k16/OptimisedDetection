            ...
            if ret:
                ...
                if(results.multi_face_landmarks != None):
                    ...
                    for person in range(detected_face):
                        ...
                        mPointsList.append(results.multi_face_landmarks[person].landmark)
                        print("Mmmm: ",len(mPointsList))
                        mpoints=results.multi_face_landmarks[0].landmark
                        left_blink=0
                        right_blink=0
                        #leftBlinkList[person] = 0
                        #rightBlinkList[person] = 0
                ...
                ###################################################         
                        ...
                        if ( yawnGList[person] == 3 ):
                            yawnCount[person]+=1
                            #print(yawn_count)
                            if(yawnCount[person]>8):
                                    print('Person'+ str(person) +'yawning')
