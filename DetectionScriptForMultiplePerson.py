            ...
            if ret:
                ...
                if(results.multi_face_landmarks != None):
                    ...
                    for person in range(detected_face):                        
                        ...
                        #if(left_blink[person] == 0 or right_blink[person] == 0):
                        if(left_blink[person] == 0):
                            ...
                            if(sleep[person]>38):
                                status="SLEEPING !!!"
                                text_color = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
                                cv2.putText(frame, "P-" + str(person+1) +"Sleeping", (220*(person*1),170+(50*person)), cv2.FONT_HERSHEY_SIMPLEX, 0.8, textColorList[person],3)
                                cv2.imshow('MediaPipe FaceMesh', frame)
                                color = (255,0,0)
                        else:
                            sleep[person] = 0
